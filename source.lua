...
local settingsTable = {
	...
	System = {
		...
		loadingScreen = {Type = 'toggle', Value = false, Name = 'Show Loading Screen'},
	}
}
...
function RayfieldLibrary:CreateWindow(Settings)
	if Rayfield:FindFirstChild('Loading') then
		...
		if getSetting("System", "loadingScreen") then
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "Rayfield Plus UI"
	end
	...
	if reporter and getSetting("System", "usageAnalytics") and getSetting("System", "loadingScreen") then then
